<template>
    <svg viewBox="0 0 24 24">
        ...
        <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="0.9">
            ...
            <path
                d="M17.255 17.15h-5.25v5.25a.75.75 0 0 0 .75.75h4.5a.75.75 0 0 0 .75-.75v-4.5a.75.75 0 0 0-.75-.75m-3-6h-4.5a.75.75 0 0 0-.75.75v5.25h6V11.9a.75.75 0 0 0-.75-.75"
            />
